...
function Get-TargetResource {
    ...
    $Current = Get-DhcpServerv4OptionValue -OptionId 119 -ErrorAction SilentlyContinue
...
function Set-TargetResource {
    ...
    if ( $Ensure -eq 'Absent' -and $Resource.Ensure -eq 'Present' ) {
        ...
        Remove-DhcpServerv4OptionValue -OptionId 119 -Confirm:$false > $null
        return
    ...
    Set-DhcpServerv4OptionValue -OptionId 119 -Value $Value -Force -Confirm:$false > $null
